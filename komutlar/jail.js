////////////////////////////////////////////
let rolid = "FAKE ÜYE ROL ID"; // BURAYA KULLANICININ TÜM ROLLERİ ALINDIKTAN SONRA VERİLECEK ROLÜN İDSİNİ YAZIN YAZMAZSANIZ TÜM ROLLERİ ALIR SADECE. 
///////////////////////////////////////////
exports.run = async (client, message, args) => {
  if (!message.member.roles.has("YETKİLİ ID"))
    return message.channel.send(
      `Bu komutu kullanabilmek için <@&YETKİLİ ID> yetkisine sahip olmasınız.`
    );
