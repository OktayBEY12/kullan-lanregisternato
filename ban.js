...
exports.run = async (bot, message, args) => {
    ...
    if (!message.member.roles.find("name", "Ban")) {
        return message.channel.send(' **Bu Komutu Kullanmak için** Ban **Rolüne Sahip Olman Lazım** ')
...
let reason = args.slice(1).join(' ')
  ...
  let embed1 = new Discord.RichEmbed()
   ...
   let embed = new Discord.RichEmbed()
                ...
                .addField(`${kisi} kişisi ${reason} sebebi ile `, "yasaklandı.")
                .setImage("https://cdn.discordapp.com/attachments/673224895756238848/673450899531628544/adalaett.gif");
                bot.channels.get("720913317585092679").send(embed1).then(message.channel.send(embed))
};
